        ...
        // --- FUNCIONALIDADE DE SELEÇÃO DE PLANO ---
        document.addEventListener('DOMContentLoaded', () => {
            const selectPlan = document.getElementById('selectPlan');
            const planContents = document.querySelectorAll('#planContent > div');

            function showSelectedPlan() {
                const selectedValue = selectPlan.value;
                planContents.forEach(contentDiv => {
            ...
            selectPlan.addEventListener('change', showSelectedPlan);

            // Hide all plan contents initially
            planContents.forEach(contentDiv => contentDiv.classList.add('hidden'));
